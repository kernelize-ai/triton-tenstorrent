...
void kernel_main() {
  ...
  for (int32_t i26 = v23; i26 < v22; i26 += v5) {
    ...
    for (int32_t j33 = v3; j33 < v25; j33 += v5) {
      ...
      noc_async_read(temp_187, cb_ctarg_0.get_write_ptr(), v19);
      {
    ...
    noc_async_write(cb_ctarg_2.get_read_ptr(), temp_176, v15);
    {
    DeviceZoneScopedN("noc_async_write_barrier");
    noc_async_write_barrier();
    }
    cb_ctarg_2.pop_front(v5);
  }
  return;
}
