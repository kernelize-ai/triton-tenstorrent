...
void kernel_main() {
  ...
  int32_t v6 = get_common_arg_val<uint32_t>(40);
  int32_t v7 = get_common_arg_val<uint32_t>(41);
  DataFormat v8 = get_dataformat(get_compile_time_arg_val(3));
  int32_t v9 = get_tile_size(get_compile_time_arg_val(3));
  ...
  for (int32_t i14 = v13; i14 < v12; i14 += v1) {
    ...
    cb_wait_front(get_compile_time_arg_val(3), v1);
    }
    int32_t v15 = get_read_ptr(get_compile_time_arg_val(3));
    ...
    cb_pop_front(get_compile_time_arg_val(3), v1);
  }
  return;
}
