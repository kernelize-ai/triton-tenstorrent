...
void kernel_main() {
  ...
  for (int32_t i36 = v33; i36 < v32; i36 += v7) {
    ...
    for (int32_t j43 = v4; j43 < ((int32_t) ((uint32_t) v19 + (uint32_t) v3) / v5); j43 += v7) {
      ...
      uint64_t temp_366 = v31.get_noc_addr((int32_t) ((uint32_t) v40 + (uint32_t) v44), v4);
      noc_async_read(temp_366, v45, v29);
      int32_t v46 = (int32_t) ((uint32_t) v44 + (uint32_t) v7);
      int32_t v47 = (int32_t) ((uint32_t) v45 + (uint32_t) v29);
      uint64_t temp_383 = v31.get_noc_addr((int32_t) ((uint32_t) v40 + (uint32_t) v46), v4);
      noc_async_read(temp_383, v47, v29);
      {
      ...
      uint64_t temp_397 = v27.get_noc_addr((int32_t) ((uint32_t) v49 + (uint32_t) v41), v4);
      noc_async_read(temp_397, v48, v25);
      int32_t v50 = (int32_t) ((uint32_t) v46 * (uint32_t) v35);
      int32_t v51 = (int32_t) ((uint32_t) v48 + (uint32_t) ((int32_t) ((uint32_t) v25 * (uint32_t) v9)));
      uint64_t temp_414 = v27.get_noc_addr((int32_t) ((uint32_t) v50 + (uint32_t) v41), v4);
      noc_async_read(temp_414, v51, v25);
      int32_t v52 = (int32_t) ((uint32_t) v48 + (uint32_t) v25);
      uint64_t temp_426 = v27.get_noc_addr((int32_t) ((uint32_t) v49 + (uint32_t) v42), v4);
      noc_async_read(temp_426, v52, v25);
      int32_t v53 = (int32_t) ((uint32_t) v48 + (uint32_t) ((int32_t) ((uint32_t) v25 * (uint32_t) 3)));
      uint64_t temp_438 = v27.get_noc_addr((int32_t) ((uint32_t) v50 + (uint32_t) v42), v4);
      noc_async_read(temp_438, v53, v25);
      {
      DeviceZoneScopedN("noc_async_read_barrier");
      noc_async_read_barrier();
      }
    ...
    uint64_t temp_357 = v23.get_noc_addr((int32_t) ((uint32_t) v55 + (uint32_t) v41), v4);
    noc_async_read(temp_357, v54, v21);
    int32_t v56 = (int32_t) ((uint32_t) v54 + (uint32_t) v21);
    uint64_t temp_369 = v23.get_noc_addr((int32_t) ((uint32_t) v55 + (uint32_t) v42), v4);
    noc_async_read(temp_369, v56, v21);
    {
    DeviceZoneScopedN("noc_async_read_barrier");
    noc_async_read_barrier();
    }
