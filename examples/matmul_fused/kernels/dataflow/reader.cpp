...
void kernel_main() {
  ...
  for (int32_t i28 = v24; i28 < v23; i28 += v5) {
    ...
    for (int32_t j32 = v3; j32 < ((int32_t) ((uint32_t) v18 + (uint32_t) v2) / v4); j32 += v5) {
      ...
      uint64_t temp_349 = v34.get_noc_addr(v36, v3);
      noc_async_read(temp_349, v35, v22);
      int32_t v37 = (int32_t) ((uint32_t) v35 + (uint32_t) v9);
      int32_t v38 = (int32_t) ((uint32_t) v36 + (uint32_t) v5);
      uint64_t temp_361 = v34.get_noc_addr(v38, v3);
      noc_async_read(temp_361, v37, v22);
      int32_t v39 = (int32_t) ((uint32_t) v35 + (uint32_t) v10);
      uint64_t temp_373 = v34.get_noc_addr((int32_t) ((uint32_t) v36 + (uint32_t) v26), v3);
      noc_async_read(temp_373, v39, v22);
      int32_t v40 = (int32_t) ((uint32_t) v35 + (uint32_t) v11);
      uint64_t temp_385 = v34.get_noc_addr((int32_t) ((uint32_t) v38 + (uint32_t) v26), v3);
      noc_async_read(temp_385, v40, v22);
      {
    ...
    uint64_t temp_329 = v42.get_noc_addr(v44, v3);
    noc_async_read(temp_329, v43, v20);
    int32_t v45 = (int32_t) ((uint32_t) v43 + (uint32_t) v10);
    int32_t v46 = (int32_t) ((uint32_t) v44 + (uint32_t) v5);
    uint64_t temp_341 = v42.get_noc_addr(v46, v3);
    noc_async_read(temp_341, v45, v20);
    int32_t v47 = (int32_t) ((uint32_t) v43 + (uint32_t) v9);
    uint64_t temp_353 = v42.get_noc_addr((int32_t) ((uint32_t) v44 + (uint32_t) v27), v3);
    noc_async_read(temp_353, v47, v20);
    int32_t v48 = (int32_t) ((uint32_t) v43 + (uint32_t) v11);
    uint64_t temp_365 = v42.get_noc_addr((int32_t) ((uint32_t) v46 + (uint32_t) v27), v3);
    noc_async_read(temp_365, v48, v20);
    {
    DeviceZoneScopedN("noc_async_read_barrier");
    noc_async_read_barrier();
    }
