...
void kernel_main() {
  ...
  mm_block_init(get_compile_time_arg_val(0), get_compile_time_arg_val(1), get_compile_time_arg_val(2), v2, v4, v5, v6);
  int32_t v15 = get_arg_val<uint32_t>(1);
  int32_t v16 = get_arg_val<uint32_t>(v1);
  for (int32_t i17 = v16; i17 < v15; i17 += v3) {
    tile_regs_acquire();
    mm_block_init_short(get_compile_time_arg_val(0), get_compile_time_arg_val(1), v2, v4, v5, v6);
    for (int32_t j18 = v2; j18 < ((int32_t) ((uint32_t) v14 + (uint32_t) 511) / 512); j18 += v3) {
      {
      ...
      experimental::matmul_block(get_compile_time_arg_val(0), get_compile_time_arg_val(1), v2, v2, v1, v2, v4, v5, v6, v4);
    ...
    pack_tile<true>(v12, get_compile_time_arg_val(2), v12);
