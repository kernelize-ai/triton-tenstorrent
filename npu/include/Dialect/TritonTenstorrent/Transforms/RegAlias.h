#ifndef TRITON_TENSTORRENT_ANALYSIS_REG_ALIAS_H
#define TRITON_TENSTORRENT_ANALYSIS_REG_ALIAS_H
...
//===----------------------------------------------------------------------===//
class RegAliasAnalysis : public dataflow::SparseForwardDataFlowAnalysis<
...
#endif // TRITON_TENSTORRENT_ANALYSIS_REG_ALIAS_H
